...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 30 mei 2017 om 00:40
...
--
-- Tabelstructuur voor tabel `army`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `building`
--
...
--
-- Tabelstructuur voor tabel `building_in_progress`
--
...
--
-- Tabelstructuur voor tabel `building_list`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `building_list`
--
...
--
-- Tabelstructuur voor tabel `cells`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `cells`
--
...
--
-- Tabelstructuur voor tabel `recrutement`
--
...
CREATE TABLE `recrutement` (
  ...
  `Recrutement_Time` time NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Gegevens worden geëxporteerd voor tabel `storage`
--

INSERT INTO `storage` (`Storage_ID`, `Food`, `Metals`, `Stone`, `Wood`, `Timestamp`) VALUES
(1, 2147483647, 2060950869, 1860845543, 1924285798, 1496078016);

-- --------------------------------------------------------

--
-- Tabelstructuur voor tabel `tech`
--
...
--
-- Tabelstructuur voor tabel `tech_list`
--
...
--
-- Tabelstructuur voor tabel `terrain`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `terrain`
--
...
(0, 1, 100, 1, 5, 20, 10, 200, 100, 30, 10, 120, 'Spear_Man');

-- --------------------------------------------------------

--
-- Tabelstructuur voor tabel `upgrade`
--
...
--
-- Tabelstructuur voor tabel `upgrade_list`
--
...
--
-- Tabelstructuur voor tabel `village`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `village`
--
...
--
-- Indexen voor tabel `army`
--
ALTER TABLE `army`
  ADD PRIMARY KEY (`Village_ID`,`Unit_ID`);
...
--
-- Indexen voor tabel `building`
--
ALTER TABLE `building`
  ADD PRIMARY KEY (`Building_ID`);

--
-- Indexen voor tabel `building_in_progress`
--
ALTER TABLE `building_in_progress`
  ADD PRIMARY KEY (`ID`);

--
-- Indexen voor tabel `building_list`
--
ALTER TABLE `building_list`
  ADD PRIMARY KEY (`Building_ID`);

--
-- Indexen voor tabel `cells`
--
ALTER TABLE `cells`
...
--
-- Indexen voor tabel `recrutement`
--
...
--
-- Indexen voor tabel `tech`
--
ALTER TABLE `tech`
  ADD PRIMARY KEY (`Tech_ID`);

--
-- Indexen voor tabel `tech_list`
--
ALTER TABLE `tech_list`
  ADD PRIMARY KEY (`Tech_ID`,`User_ID`);

--
-- Indexen voor tabel `terrain`
--
ALTER TABLE `terrain`
...
--
-- Indexen voor tabel `upgrade`
--
ALTER TABLE `upgrade`
  ADD PRIMARY KEY (`Upgrade_ID`);

--
-- Indexen voor tabel `upgrade_list`
--
...
--
-- AUTO_INCREMENT voor een tabel `recrutement`
--
ALTER TABLE `recrutement`
  MODIFY `Recrutement_ID` int(255) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT voor een tabel `village`
--
ALTER TABLE `village`
